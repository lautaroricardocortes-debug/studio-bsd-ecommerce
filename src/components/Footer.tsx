            ...
            <ul className="space-y-2 text-sm text-bsd-text-secondary">
              <li>
                <a
                  ...
                  className="hover:text-bsd-primary"
                >
            ...
            {socialLinks.map((social) => {
              ...
              return Icon ? (
                <a
                  ...
                  className="text-bsd-text-secondary transition-colors hover:text-bsd-primary"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={social.label}
                  className="text-bsd-text-secondary transition-colors hover:text-[#25D366]"
                >
